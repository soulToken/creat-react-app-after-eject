...
const px2rem = require('postcss-px2rem-exclude');  //适配
      ...
      rules: [
        ...
        
        {
          ...
          oneOf: [
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              options: {
                ...
                plugins: [
                  ...
                  ["import", {"libraryName": "antd-mobile", "style": true}],   //引入antd-mobile less文件
                ],
            ...
            //自定义 antd-mobile 主题色配置
            {
              test: /\.less$/,
              use: [
                  'style-loader',
                  'css-loader',
                  {loader: 'less-loader', options: {modifyVars: theme,javascriptEnable:true}},
              ],
              include: /node_modules/,
              // {"brand-primary": "blue","color-text-base":  "red"}
          },
