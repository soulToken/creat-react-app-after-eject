...
import money from '@/assets/icons/svg/money.svg'
...
class Demo extends Component{
    ...
    return (
      ...
      <div style={{height:'1000px'}}>   
          ...
          <Icon type="search"  />
        {/* <ReactSVG src={require(`@/assets/icons/svg/money.svg`)} className="svgClass"  />     */}
        <Button className="btn_class">default</Button><WhiteSpace />
